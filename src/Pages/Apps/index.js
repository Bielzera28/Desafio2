...
function Apps() {
  return (
    <div className="apps-container">
      <div className="apps-container__content">
        <Text fontSize={32} fontWeight={700} color="#293145">
          Baixe nosso app para desfrutar mais!
        </Text>
        <Text fontSize={16} color="#6E7275">
          Amet in elementum nulla scelerisque dui, egestas at. Elit
          <br /> consectetur turpis elementum amet vitae et etiam nec.
          <br /> Varius volutpat hac adipiscing tincidunt pretium.
        </Text>
